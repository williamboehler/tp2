...
class FizzBuzzTest(TestCase):
    ...
    def test_returns_fizz_for_input_divisible_by_3_but_not_5(self):
        ...
        self.assertEqual('Fizz', self.fizzbuzz.convert(21))
        self.assertEqual('Fizz', self.fizzbuzz.convert(24))
    ...
    def test_returns_buzz_for_input_divisible_by_5_but_not_3(self):
        ...
        self.assertEqual('Buzz', self.fizzbuzz.convert(40))
        self.assertEqual('Buzz', self.fizzbuzz.convert(50))
    ...
    def test_returns_fizzbuzz_for_input_divisible_by_3_and_5(self):
        ...
        self.assertEqual('FizzBuzz', self.fizzbuzz.convert(90))
        self.assertEqual('FizzBuzz', self.fizzbuzz.convert(105))
